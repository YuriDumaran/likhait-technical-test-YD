...
const HistoryPage: React.FC = () => {
  ...
  const breakdownCategories = Object.values(categoryData).sort(
    (a, b) => b.amount - a.amount,
  );
  const total = breakdownCategories.reduce((sum, cat) => sum + cat.amount, 0);
  const totalCount = breakdownCategories.reduce((sum, cat) => sum + cat.count, 0);
